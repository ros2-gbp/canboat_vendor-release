## canboat_vendor (kilted) - 0.0.6-1

The packages in the `canboat_vendor` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted --track kilted canboat_vendor` on `Fri, 08 Aug 2025 18:40:18 -0000`
...
## canboat_vendor (jazzy) - 0.0.6-1

The packages in the `canboat_vendor` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy --track jazzy canboat_vendor` on `Fri, 08 Aug 2025 16:56:34 -0000`
...
## canboat_vendor (jazzy) - 0.0.5-1

The packages in the `canboat_vendor` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy --track jazzy canboat_vendor` on `Wed, 06 Aug 2025 13:14:23 -0000`
...
## canboat_vendor (jazzy) - 0.0.4-1

The packages in the `canboat_vendor` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy --track jazzy canboat_vendor` on `Thu, 24 Jul 2025 13:48:05 -0000`
